...
class SFDADataset(Dataset):
    ...
    def __init__(self, args, data_dir, data_list, d_type, preload_flg=True) -> None:   # This method does not return an explicit value
        ...
        self.shared_class_num = args.shared_class_num     # set manually
