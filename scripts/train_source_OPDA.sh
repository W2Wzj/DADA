...
python train_source.py --backbone_arch resnet101 --dataset VisDA --s_idx 0  --target_label_type OPDA --epochs 15 --lr 0.001 --gpu 1
python train_source.py --backbone_arch resnet101 --dataset VisDA --s_idx 0  --target_label_type OSDA --epochs 15 --lr 0.001 --gpu 1
